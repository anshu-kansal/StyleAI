...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-[75vh] flex items-center justify-center px-4 py-12 bg-slate-50/50 dark:bg-slate-950/20">
      <div className="max-w-md w-full bg-white border border-slate-100 rounded-3xl p-8 sm:p-10 shadow-xl shadow-slate-100/50 dark:bg-slate-900 dark:border-slate-800 dark:shadow-none space-y-8 transition-all duration-300">
        
        {/* Logo/Heading */}
        <div className="text-center space-y-2">
          <h2 className="text-3xl font-serif font-black tracking-tight text-slate-900 dark:text-white">
            Style<span className="text-brand-accent">AI</span>
          </h2>
        ...
        <div className="flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-full">
          <button
            ...
            className={`flex-1 text-center py-2.5 rounded-full text-xs font-semibold tracking-wide uppercase transition-all duration-300 cursor-pointer ${
              activeTab === 'signin'
                ? 'bg-white text-slate-900 shadow-md shadow-slate-200/50 dark:bg-slate-700 dark:text-white dark:shadow-none'
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 bg-slate-50 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent/20 focus:border-brand-accent transition-all duration-200 dark:bg-slate-800 dark:border-slate-700 dark:text-white ${
                    errors.name ? 'border-rose-400 ring-2 ring-rose-100 dark:ring-rose-950/20' : 'border-slate-200'
                  }`}
                />
              </div>
              {errors.name && (
